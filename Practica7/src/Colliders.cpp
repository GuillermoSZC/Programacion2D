...
void CircleCollider::SetPosition(Vec2& _position)
{
    circlePosition = _position;
}

void CircleCollider::SetSize(Vec2& _size) 
{
    radius = _size.x * 0.5f;
}
...
void RectCollider::SetPosition(Vec2& _position)
{
    rectPosition = _position;
}
...
void PixelsCollider::SetPosition(Vec2& _position)
{
    pixelPosition = _position;
}

void PixelsCollider::SetSize(Vec2& _size) 
{
    pixelSize = _size;
}
